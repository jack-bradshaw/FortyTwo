...
### AnswerGroup
Display and coordinate multiple answer by adding an AnswerGroup to your layout. The SelectionLimitAnswerGroup is the only provided answer group and it should be flexible enough to meet most needs.
```xml
<LinearLayout
